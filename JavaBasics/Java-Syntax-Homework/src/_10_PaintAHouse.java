...
//it is not my problem's solution; I just try it
public class _10_PaintAHouse {
    ...
    public static void main(String[] args) {
        ...
        boolean toTheRightSide = ((17.5 - 12.5) * (data[1] - 8.5) - 
				(3.5 - 8.5) * (data[0] - 12.5)) >= 0;
		boolean toTheLeftSide = ((22.5 - 17.5) * (data[1] - 3.5) - 
				(8.5 - 3.5) * (data[0] - 17.5))	>= 0;								
		boolean toTheUpperSide = ((22.5 - 12.5) * (data[1] - 8.5) - 
				(8.5 - 8.5) * (data[0] - 12.5)) <= 0;
		boolean isInsidePartOne = toTheRightSide && toTheLeftSide && toTheUpperSide;
		boolean isInsidePartTwo = (data[0] >= 12.5) && 
				(data[0] <= 17.5) && (data[1] >= 8.5) && (data[1] <= 13.5);
		boolean isInsidePartThree = (data[0] >= 20) && 
				(data[0] <= 22.5) && (data[1] >= 8.5) && (data[1] <= 13.5);
		boolean isInsideHouse = isInsidePartOne || isInsidePartTwo || isInsidePartThree;
